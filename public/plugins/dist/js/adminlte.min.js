...
!(function (e, t) {
          ...
          if (e.hasClass(A)) {
            var t = {
              ...
              o =
                ...
                "fixed" === n.default(k).css("position"),
              s =
                (e.hasClass(F) ||
                  e.hasClass(R) ||
                  e.hasClass(D) ||
                  e.hasClass(M) ||
                  e.hasClass(q)) &&
                "fixed" === n.default(H).css("position"),
              l = n.default(Q),
              r = n.default(
            ...
            if (0 === i && 0 === a)
              ...
              i <= t.header
                ? !1 === o
                  ? (l.css("top", t.header - i),
                    r.css("height", t.window - (t.header - i)))
                  : l.css("top", t.header)
                : !1 === o
  ...
  n
    ...
    (n.default.fn[T] = N._jQueryInterface),
    (n.default.fn[T].Constructor = N),
      ...
      return (
        ...
        (e._jQueryInterface = function (t) {
          return this.each(function () {
            ...
            a || ((a = new e(n.default(this))), n.default(this).data(B, a)),
              a[t]();
          });
        }),
        e
  ...
  n
    ...
    .on("click", '[data-widget="chat-pane-toggle"]', function (e) {
      e && e.preventDefault(),
        $._jQueryInterface.call(n.default(this), "toggle");
    }),
    (n.default.fn[P] = $._jQueryInterface),
    (n.default.fn[P].Constructor = $),
      ...
      return (
        ...
        (e._jQueryInterface = function (t) {
          return this.each(function () {
            ...
            a || ((a = new e(n.default(this), i)), n.default(this).data(G, a)),
  ...
  n
    ...
    .on("click", function (e) {
      e.preventDefault(),
        e.stopPropagation(),
        X._jQueryInterface.call(n.default(this), "toggleSubmenu");
    }),
    ...
    (n.default.fn[W] = X._jQueryInterface),
    (n.default.fn[W].Constructor = X),
      ...
      return (
        ...
        (e._jQueryInterface = function (t) {
          return this.each(function () {
            ...
            a || ((a = new e(n.default(this))), n.default(this).data(Z, a)),
  ...
  n.default(".expandable-table").ready(function () {
    ...
    (n.default.fn[Y] = ne._jQueryInterface),
    (n.default.fn[Y].Constructor = ne),
    ...
    fe = (function () {
      ...
      return (
        ...
        (e._jQueryInterface = function (t) {
          ...
          n.default(this).data(oe, "object" == typeof t ? t : a),
  ...
  n.default(document).on("click", le, function () {
    ...
    (n.default.fn[ie] = fe._jQueryInterface),
    (n.default.fn[ie].Constructor = fe),
    (n.default.fn[ie].noConflict = function () {
    ...
    Qe = (function () {
      ...
      return (
              ...
              f.fadeIn(),
                n.default(s + " iframe").ready(function () {
                  "number" == typeof o._config.loadingScreen
                    ? (o.switchTab("#" + l, o._config.loadingScreen),
                      setTimeout(function () {
                        f.fadeOut();
        ...
        (t.openTabSidebar = function (e, t) {
          ...
          "#" !== o &&
            ...
            this.createTab(
              i,
              o,
              o.replace(".html", "").replace("./", "").replaceAll("/", "-"),
              t
            );
        }),
        ...
        (t.removeActiveTab = function () {
          ...
          if (
            (e.remove(),
            n.default(".tab-pane.active").remove(),
            n.default(be).children().length == n.default(Ce + ", " + ye).length)
          )
            n.default(Ce).show();
          else {
            var i = a - 1;
        ...
        (t.toggleFullscreen = function () {
          n.default("body").hasClass(je)
            ? (n
              ...
              n.default(Ce + ", " + ye).height("auto"),
              n.default(pe).height("auto"),
              n.default(me).height("auto"))
            : (n
                .default(ge + " i")
        ...
        (t._init = function () {
          window.frameElement && this._config.autoIframeMode
            ? n.default("body").addClass(Te)
            : n.default(pe).hasClass(Te) &&
        ...
        (t._setupListeners = function () {
          ...
          n.default(window).on("resize", function () {
            ...
            this._config.useNavbarItems &&
              n.default(document).on("click", xe + ", " + Ie, function (t) {
                t.preventDefault(), e.openTabSidebar(t.target);
              }),
        ...
        (t._setItemActive = function (e) {
          n.default(we + ", " + Ie).removeClass("active"),
            n.default(xe).parent().removeClass("active");
        ...
        (t._fixHeight = function (e) {
          if ((void 0 === e && (e = !1), n.default("body").hasClass(je))) {
            var t = n.default(window).height();
            n.default(Ce + ", " + ye).height(t),
              n.default(pe).height(t),
              n.default(me).height(t);
          } else {
            var a = parseFloat(n.default(pe).css("min-height")),
              i = n
                .default('[data-widget="iframe"].iframe-mode .nav')
                .outerHeight();
            1 == e
              ? setTimeout(function () {
                  n.default(Ce + ", " + ye).height(a - i);
                }, 50)
              : n.default(me).height(a - i);
          }
        }),
        (e._jQueryInterface = function (t) {
          ...
          if (
            (a || ((a = new e(this, i)), n.default(this).data(ue, a)),
            "string" == typeof t &&
              t.match(/createTab|openTabSidebar|switchTab|removeActiveTab/))
          ) {
            for (
              var o,
                s = arguments.length,
      ...
      return (
        (t.fixLayoutHeight = function (e) {
          ...
          (t.hasClass("control-sidebar-slide-open") ||
            ...
            "control_sidebar" === e) &&
            (a = n.default(".control-sidebar-content").height());
          var i = {
              window: n.default(window).height(),
              header:
                0 !== n.default(ze).length ? n.default(ze).outerHeight() : 0,
              footer:
                0 !== n.default(Ae).length ? n.default(Ae).outerHeight() : 0,
        ...
        (e._jQueryInterface = function (t) {
          return (
            ...
            this.each(function () {
              ...
              a ||
                ((a = new e(n.default(this), i)), n.default(this).data(ke, a)),
                "init" === t || "" === t
                  ? a._init()
                  : ("fixLayoutHeight" !== t &&
  ...
  n.default(window).on("load", function () {
    ...
    (n.default.fn.Layout = De._jQueryInterface),
    (n.default.fn.Layout.Constructor = De),
    ...
    Ke = (function () {
      ...
      return (
        ...
        (t.collapse = function () {
          ...
          this._options.autoCollapseSize &&
            n.default(window).width() <= this._options.autoCollapseSize &&
            e.removeClass($e).addClass(Ge),
            e.addClass(Ue),
            this._options.enableRemember &&
              localStorage.setItem("remember" + Oe, Ue),
            n
              .default(this._element)
        ...
        (t.remember = function () {
          if (this._options.enableRemember) {
            var e = n.default("body");
            localStorage.getItem("remember" + Oe) === Ue
        ...
        (e._jQueryInterface = function (t) {
          return this.each(function () {
            ...
            a || ((a = new e(this, i)), n.default(this).data(qe, a)),
              "string" == typeof t &&
  ...
  n.default(document).on("click", Pe, function (e) {
    ...
    "pushmenu" !== n.default(t).data("widget") &&
      (t = n.default(t).closest(Pe)),
      Ke._jQueryInterface.call(n.default(t), "toggle");
  }),
    n.default(window).on("load", function () {
      Ke._jQueryInterface.call(n.default(Pe));
    }),
    (n.default.fn[Me] = Ke._jQueryInterface),
    (n.default.fn[Me].Constructor = Ke),
    (n.default.fn[Me].noConflict = function () {
  ...
  var Ve = "SidebarSearch",
    ...
    ct = (function () {
      function e(e, t) {
        (this.element = e),
          (this.options = n.default.extend({}, ft, t)),
          (this.items = []);
      }
      var a = e.prototype;
      return (
        (a.init = function () {
          var e = this;
          0 != n.default(it).length &&
            (0 == n.default(it).next(rt).length &&
              n.default(it).after(n.default("<div />", { class: at })),
            0 == n.default(rt).children(".list-group").length &&
              n.default(rt).append(n.default("<div />", { class: nt })),
            this._addNotFound(),
            n
        ...
        (a.search = function () {
          ...
          if (t.length < this.options.minLength)
            return (
              n.default(dt).empty(), this._addNotFound(), void this.close()
            );
        ...
        (a.open = function () {
          n.default(it).parent().addClass(Ze),
            n.default(lt).removeClass(et).addClass(tt);
        }),
        (a.close = function () {
          n.default(it).parent().removeClass(Ze),
            n.default(lt).removeClass(tt).addClass(et);
        }),
        (a.toggle = function () {
          ...
          if (
            ...
            this.options.highlightName &&
              (e = e.replace(s, function (e) {
                return (
                  '<b class="' + i.options.highlightClass + '">' + e + "</b>"
                );
              })),
        ...
        (e._jQueryInterface = function (t) {
          ...
          var i = n.default.extend({}, ft, "object" == typeof t ? t : a),
            o = new e(n.default(this), i);
          n.default(this).data(Xe, "object" == typeof t ? t : a),
  ...
  n.default(document).on("click", st, function (e) {
    ...
    n.default(document).on("keyup", ot, function (e) {
      if (38 == e.keyCode)
        return e.preventDefault(), void n.default(dt).children().last().focus();
      if (40 == e.keyCode)
        return (
          e.preventDefault(), void n.default(dt).children().first().focus()
        );
      var t = 0;
      clearTimeout(t),
    ...
    (n.default.fn[Ve] = ct._jQueryInterface),
    (n.default.fn[Ve].Constructor = ct),
    ...
    bt = (function () {
      ...
      return (
        ...
        (t._getContainerId = function () {
          return this._config.position == gt
            ? "#toastsContainerTopRight"
            : this._config.position == pt
            ? "#toastsContainerTopLeft"
            : this._config.position == mt
            ? "#toastsContainerBottomRight"
            : this._config.position == vt
  ...
  (n.default.fn.Toasts = bt._jQueryInterface),
    (n.default.fn.Toasts.Constructor = bt),
    ...
    Tt = (function () {
      ...
      return (
        ...
        (t._init = function () {
          var e = this,
            t = this._element;
          t.find("input:checkbox:checked").parents("li").toggleClass(xt),
        ...
        (e._jQueryInterface = function (t) {
          return this.each(function () {
            ...
            var i = n.default.extend({}, It, "object" == typeof t ? t : a),
              o = new e(n.default(this), i);
            n.default(this).data(yt, "object" == typeof t ? t : a),
              "init" === t && o[t]();
          });
        }),
        e
  ...
  n.default(window).on("load", function () {
    ...
    (n.default.fn[Ct] = Tt._jQueryInterface),
    (n.default.fn[Ct].Constructor = Tt),
    (n.default.fn[Ct].noConflict = function () {
    ...
    Rt = (function () {
      ...
      return (
        ...
        (t.toggle = function (e) {
          ...
          if (
            i.is(Ht) ||
            (a.is(kt) || (i = a.parent().find("> .nav-treeview")), i.is(Ht))
          ) {
            e.preventDefault();
        ...
        (e._jQueryInterface = function (t) {
          return this.each(function () {
            ...
            a || ((a = new e(n.default(this), i)), n.default(this).data(St, a)),
              "init" === t && a[t]();
          });
        }),
        e
  ...
  n.default(window).on("load.lte.treeview", function () {
    ...
    (n.default.fn[jt] = Rt._jQueryInterface),
    (n.default.fn[jt].Constructor = Rt),
