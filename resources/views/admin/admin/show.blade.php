...
<div class="card card-secondary card-outline">
  <div class="card-body">
    <div class="row">
      <x-input class="col-xl-4 col-md-6 form-group" name="full_name" label="Nome Completo" value="{{$admin->full_name}}" disabled/>
    </div>
    <div class="row">
      <x-input class="col-xl-4 col-md-6 form-group" name="email" label="Email" value="{{$admin->email}}" disabled/>
    </div>
    <div class="row">
      <x-input class="col-xl-4 col-md-6 form-group" label="CPF" value="{{$admin->cpf}}" disabled/>
    </div>
    <div class="row">
      <x-input class="col-xl-4 col-md-6 form-group" name="birthday" label="Data de Aniversário" value="{{$admin->birthday}}" disabled/>
    </div>
    <div class="row">
